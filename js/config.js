...
window.Roll.CONFIG = {
  ...
  firstBookableDay: 4,       // days 1-3 are visible but cannot be booked
  ...
  supabaseUrl: 'https://bdicnffckyjcsivxdqmm.supabase.co',
  supabaseAnonKey: 'sb_publishable_yg3HnBUOyr6ShPFgkPOtSw_klpqajzs',
  photoBucket: 'senior-photos',
